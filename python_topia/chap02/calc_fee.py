...
# 結果を表示
print("子供料金     :{0}人ｘ  500= {1}円".format(children, children_price))
print("通常料金     :{0}人ｘ 1000= {1}円".format(normal, normal_price))
print("年配者料金   :{0}人ｘ  700= {1}円".format(elder, elder_price))
